...
public class CustomerServiceTest {
    ...
    // 2 tane testimiz olacak. Biri böyle bir idli customerın olması veya olmaması durumu.
    ...
    @Test
    public void testGetByCustomerById_whenCustomerIdExists_shouldReturnCustomer() {
        Customer customer = new Customer("id", "name", "surname", Set.of());
    ...
    @Test
    public void testGetByCustomerById_whenCustomerIdDoesNotExists_shouldThrowCustomerNotFoundException() {
